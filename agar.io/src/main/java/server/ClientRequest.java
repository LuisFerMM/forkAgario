	...
	private void handleRequest(Socket socket2) {
		try {
			...
			if(httpMethod.equals("GET"))
			{
				...
				if(httpQueryString.contains("ced=") && httpQueryString.contains("pass="))
				{
					System.out.println("Get method processed");
					...
					.append("<style>")
					.append("body{")
					.append("	background-image: url(\"http://img01.deviantart.net/4b24/i/2015/160/3/2/agar_io_by_alexia_way-d8wo9zt.jpg\");")
					.append("}")
					.append("</style>")
					.append("<title>Informacion Nickname Correspondiente</title>")
					.append("</head>")
					.append("<body>")
					.append("<h1>Partidas jugadas</h1>")
					.append("<table>")
					.append("<tr>")
					.append("<td><strong>Nickname</strong></td>")
					.append("<td><strong>e-mail</strong></td>")
					.append("<td><strong>Score</strong></td>")
					.append("<td><strong>Enemies</strong></td>");
